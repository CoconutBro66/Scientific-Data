...
output_dir = "./loc_baseline_model_mdeberta-v3-base_new"
...
training_args = TrainingArguments(
    ...
    num_train_epochs=30,
    weight_decay=0.01,
    logging_dir="./logs_loc_baseline_mdeberta-v3-base_new",
    logging_steps=50,
...
if __name__=="__main__":
    ...
    os.makedirs("results/mdeberta-v3-base",exist_ok=True)
    save_path="results/mdeberta-v3-base/loc_baseline_results.txt"
